...
@parent
        ...
        <script src="{{ base_url('js/module/admin/table.js') }}" type="text/javascript"></script>
@endsection
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="exampleModalLabel1">Table</h4> </div>
                        <div class="modal-body">
                            <form id="FormData" data-toggle="validator" data-delay="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code" data-error="Hmm, Code harap diisi" required>
